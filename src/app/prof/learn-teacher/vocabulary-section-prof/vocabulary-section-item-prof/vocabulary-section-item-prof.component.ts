...
@Component({
  selector: 'app-vocabulary-section-item-prof',
  templateUrl: './vocabulary-section-item-prof.component.html',
  styleUrls: ['./vocabulary-section-item-prof.component.scss']
})
export class VocabularySectionItemProfComponent implements OnInit {
